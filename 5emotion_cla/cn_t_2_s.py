...
_u_simp2trad = dict((k.decode('utf8'), v.decode('utf8')) for k, v in _simp2trad.iteritems())
_u_trad2simp = dict((v.decode('utf8'), k.decode('utf8')) for k, v in _simp2trad.iteritems())
